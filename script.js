...
const WORD_BANK = [
    // A
    "ABBEY","ABBOT","ABHOR","ABIDE","ABLER","ABODE","ABOUT","ABOVE","ABUSE","ABYSS",
    "ACTED","ACUTE","ADAGE","ADAPT","ADDED","ADEPT","ADULT","AFTER","AGILE","AGING",
    "AGONY","AGREE","AHEAD","AISLE","ALARM","ALBUM","ALERT","ALIBI","ALIEN","ALIKE",
    "ALIGN","ALIVE","ALLAY","ALLEY","ALLOW","ALONE","ALONG","ALOOF","ALTER","AMBER",
    "AMBLE","AMEND","AMPLE","ANGEL","ANGER","ANGLE","ANGRY","ANNEX","ANTIC","ANVIL",
    "APART","APPLE","APTLY","ARDOR","ARENA","ARGUE","ARISE","ARMOR","AROMA","AROSE",
    "ARRAY","ASIDE","ASKED","ASSAY","ASSET","ATLAS","ATONE","ATTIC","AUDIT","AVAIL",
    "AVERT","AVID","AVOID","AWAKE","AWARD","AWARE","AWFUL","AXIAL",

    // B
    "BACON","BADGE","BADLY","BAKER","BASIC","BASIN","BATCH","BEACH","BEARD","BEAST",
    "BEGIN","BEING","BELLE","BELOW","BENCH","BINGE","BLACK","BLADE","BLAME","BLAND",
    "BLAST","BLAZE","BLEAK","BLEAT","BLEED","BLEND","BLESS","BLIND","BLOCK","BLOOD",
    "BLOOM","BLOWN","BLUES","BLUNT","BLURB","BOARD","BOAST","BOOST","BOOTH","BOUND",
    "BOXER","BRAIN","BRAND","BRAVE","BRAWL","BREAD","BREAK","BREED","BREVE","BRIDE",
    "BRIEF","BRINE","BRING","BRINK","BRISK","BROOD","BROOK","BROTH","BROWN","BRUNT",
    "BRUSH","BUILD","BUILT","BULGE","BULLY","BURST","BUYER",

    // C
    "CABIN","CAMEL","CANDY","CARGO","CARRY","CATCH","CAUSE","CEASE","CHAIN","CHAIR",
    "CHAMP","CHAOS","CHARM","CHASE","CHEAP","CHECK","CHEEK","CHEER","CHESS","CHEST",
    "CHIEF","CHILD","CHILL","CHORD","CIVIL","CLAMP","CLANG","CLASH","CLASP","CLEAN",
    "CLEAR","CLERK","CLICK","CLIFF","CLING","CLOAK","CLOCK","CLONE","CLOSE","CLOTH",
    "CLOUD","CLOUT","COACH","COMET","COMIC","COMMA","CORAL","COULD","COUNT","COURT",
    "COVER","CRAFT","CRANE","CRASH","CRAZE","CREED","CREEP","CREST","CRIME","CRISP",
    "CROSS","CROWD","CROWN","CRUSH","CRYPT","CURVE",

    // D
    "DAILY","DAISY","DANCE","DATUM","DECAY","DEFER","DELTA","DEMON","DENSE","DEPOT",
    "DEPTH","DIRTY","DISCO","DITCH","DIVER","DIZZY","DODGE","DOING","DONOR","DOUBT",
    "DOUGH","DRAFT","DRAIN","DRAMA","DRANK","DRAWN","DREAD","DREAM","DRILL","DRINK",
    "DRIVE","DROWN","DRUMS","DRYER","DUSKY","DWARF","DWELL","DYING",

    // E
    "EAGER","EARLY","EARTH","EIGHT","EJECT","ELDER","ELECT","ELITE","EMBER","EMPTY",
    "ENACT","ENEMY","ENJOY","ENTRY","EQUAL","ERUPT","ESSAY","EVENT","EVERY","EXACT",
    "EXERT","EXILE","EXIST","EXTRA",

    // F
    "FABLE","FACET","FAINT","FAITH","FANCY","FATAL","FEAST","FERRY","FETCH","FEVER",
    "FIELD","FIERY","FIFTH","FIFTY","FIGHT","FINAL","FLAME","FLASH","FLEET","FLESH",
    "FLOAT","FLOOD","FLOOR","FLUTE","FOCAL","FOGGY","FORCE","FORGE","FORTE","FORUM",
    "FOUND","FRAME","FRANK","FRESH","FROST","FROZE","FRUIT","FULLY","FUNNY","FUROR",
    "FUZZY",

    // G
    "GAUGE","GHOST","GIANT","GIDDY","GIVEN","GLAND","GLARE","GLAZE","GLEAM","GLIDE",
    "GLOOM","GLORY","GLOSS","GLOVE","GOING","GRACE","GRADE","GRAFT","GRAIN","GRAND",
    "GRANT","GRASP","GRAZE","GREED","GREET","GRIEF","GRIME","GRIST","GROAN","GROOM",
    "GROSS","GROUP","GROVE","GROWL","GRUEL","GRUFF","GUARD","GUIDE","GUILT","GUISE",
    "GUSTO","GUSTY",

    // H
    "HABIT","HARDY","HARSH","HASTE","HAVEN","HAZED","HEART","HEAVE","HEAVY","HEDGE",
    "HENCE","HERBS","HINGE","HOIST","HOLLY","HOMER","HONEY","HONOR","HOTEL","HOUND",
    "HOVER","HUMAN","HUMID","HUMOR","HUNKY","HURRY","HUSKY","HYENA",

    // I
    "ICING","IDEAL","IDIOM","IDIOT","IDYLL","IMAGE","IMPLY","INDEX","INFER","INFIX",
    "INGOT","INNER","INPUT","INTER","INTRO","IRONY","IVORY",

    // J
    "JAUNT","JAZZY","JEWEL","JIHAD","JOUST","JUDGE","JUICE","JUICY","JUMPY","JUROR",

    // K
    "KARMA","KAYAK","KINKY","KNACK","KNAVE","KNEEL","KNIFE","KNOCK","KNOLL","KNOTS",
    "KNOWN",

    // L
    "LANCE","LARGE","LASER","LATCH","LAUGH","LAYER","LEACH","LEAKY","LEAPT","LEASE",
    "LEGAL","LEMON","LEVEL","LIGHT","LIMIT","LINER","LIVER","LOCAL","LODGE","LOGIC",
    "LOOPY","LOTUS","LOUSE","LOWER","LUCID","LUMEN","LUMPY","LUNAR","LURCH","LUSTY",

    // M
    "MAGIC","MAJOR","MAKER","MANOR","MAPLE","MARCH","MARRY","MASSE","MATCH","MAXIM",
    "MELEE","MERCY","MERIT","METAL","MILKY","MIMIC","MINCE","MIRTH","MISER","MISTY",
    "MIXER","MOCHA","MODAL","MODEL","MOGUL","MOLDY","MONEY","MONTH","MOODY","MOOSE",
    "MORAL","MOURN","MOUTH","MOVIE","MUDDY","MURKY","MUSTY","MYRRH","MYSTIC",

    // N
    "NAIVE","NAVEL","NEEDY","NERVE","NEVER","NOBLE","NOISE","NONCE","NORTH","NOTCH",
    "NOVEL","NUDGE","NURSE",

    // O
    "OCCUR","OCEAN","OFFAL","OLIVE","ONSET","OPTIC","ORDER","ORGAN","OUTER","OUTDO",
    "OVARY","OVERT","OWNER",

    // P
    "PACED","PAINT","PANIC","PARTY","PASTA","PATCH","PAUSE","PEACE","PEDAL","PERCH",
    "PERKY","PHAGE","PHASE","PHONE","PHOTO","PIANO","PLAID","PLAIN","PLANK","PLANT",
    "PLATE","PLAZA","PLEAD","PLUCK","PLUMB","PLUME","PLUNK","PLUSH","POINT","POKER",
    "POLAR","POLKA","POPPY","PORKY","POSSE","POUCH","POUTY","POWER","PRESS","PRIVY",
    "PROBE","PRONE","PROUD","PROWL","PRUNE","PULSE","PUNCH","PURGE",

    // Q
    "QUACK","QUAFF","QUALM","QUART","QUEEN","QUERY","QUEST","QUEUE","QUICK","QUIRK",
    "QUOTA","QUOTE",

    // R
    "RADAR","RAINY","RALLY","RAVEN","REACH","REALM","REBEL","REEDY","REGAL","REIGN",
    "RELAX","RELAY","REPAY","REPEL","REPLY","RESIN","REVEL","RIGID","RISKY","RIVET",
    "ROAST","ROCKY","ROUGE","ROUGH","ROUND","ROVER","ROWDY","ROYAL","RUGBY","RULER",
    "RUSTY",

    // S
    "SAINT","SALVE","SANDY","SAUCE","SAVVY","SCALD","SCALP","SCANT","SCARE","SCORN",
    "SCOUT","SCRAM","SCRAP","SCREW","SCRUB","SEIZE","SENSE","SERUM","SERVE","SETUP",
    "SHAKE","SHAKY","SHALL","SHAME","SHAPE","SHARE","SHARK","SHARP","SHEER","SHELF",
    "SHIFT","SHINE","SHINY","SHIRE","SHIRT","SHOCK","SHOOT","SHORE","SHOUT","SHOVEL",
    "SHOVE","SHOWY","SHRED","SHRUG","SIEGE","SIEVE","SIREN","SKILL","SKULK","SKYWARD",
    "SLASH","SLEEK","SLEEK","SLEET","SLICK","SLINK","SLOPE","SLOTH","SLUG","SMACK",
    "SMEAR","SMELL","SMIRK","SMITE","SMOCK","SNARE","SNARL","SNEAK","SNEER","SNIFF",
    "SNORE","SNORT","SOGGY","SOLAR","SOLID","SOLVE","SONIC","SORRY","SPADE","SPARE",
    "SPARK","SPAWN","SPEAK","SPECK","SPICY","SPIKE","SPINE","SPITE","SPLIT","SPREE",
    "SPRIG","SQUAD","SQUAT","SQUID","STACK","STAFF","STAGE","STAIN","STALE","STALL",
    "STAMP","STAND","STANK","STARK","STEAD","STEAL","STEAM","STEEL","STEEP","STEER",
    "STERN","STICK","STIFF","STOMP","STONE","STONY","STORK","STORY","STOUT","STRAP",
    "STRAW","STRAY","STRUT","STUCK","STUNG","STUNK","STUNT","SUAVE","SULKY","SUNNY",
    "SUPER","SURGE","SWAMP","SWEAR","SWEAT","SWEEP","SWEET","SWELL","SWEPT","SWING",
    "SWIRL","SWORD","SWORE",

    // T
    "TABOO","TALON","TANGO","TENSE","TEPID","THICK","THORN","THOSE","THREE","THREW",
    "THROE","THROW","THRUM","TIARA","TIDAL","TIGER","TIMED","TIMID","TIPSY","TITHE",
    "TOKEN","TOPAZ","TORSO","TOTEM","TRACE","TRACK","TRAIL","TRAWL","TREAD","TREAT",
    "TREND","TRICK","TRIBE","TRIPE","TRITE","TROLL","TROOP","TROTH","TROVE","TRUCE",
    "TRULY","TRUMP","TRUTH","TUNER","TUNIC","TURBO","TWEAK","TWICE","TWILL","TWIST",
    "TYING",

    // U
    "UDDER","ULCER","UNFIT","UNION","UNITY","UNTIL","UNZIP","UPSET","USHER","UTTER",

    // V
    "VAGUE","VALID","VALOR","VALUE","VAPID","VAULT","VICAR","VIGOR","VINYL","VIPER",
    "VIRAL","VIVID","VOCAL","VODKA","VOILA","VOUCH","VOWEL",

    // W
    "WALTZ","WASTE","WATCH","WEAVE","WEDGE","WEIRD","WHELP","WHERE","WHICH","WHIFF",
    "WHILE","WHIRL","WHISK","WHITE","WHOLE","WHOSE","WIDER","WIELD","WINDY","WISPY",
    "WITCH","WITTY","WOMAN","WOMEN","WRATH","WREST","WRING","WROTE",

    // X / Y / Z
    "YEARN","YODEL","YOUNG","YOUTH","ZESTY","ZILCH","ZIPPY","ZONAL","ZONED",

    // Original bank (kept for target word variety)
    ...
    "TRAIN","TRUCK","TULIP","WATER","WHALE","WORLD","WRITE","YOUTH","ZEBRA","GHOST"
];
